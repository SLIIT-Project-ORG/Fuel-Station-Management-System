...
export default function FuelPassProfile() {
    ...
    return (
        ...
        <div className="container card text-light" style={{backgroundColor:'#484949'}}>
            <center>
                <div className="mt-4 text-light bg-dark p-2">
                    <h1>FUEL PASS</h1>
                </div>
                <div className="row mt-4">
                    ...
                    <div className="col-5" style={{ marginLeft: '-50px' }}>
                        ...
                        <Button variant="contained" style={{ 'height': '40px', 'width': '400px', 'marginLeft': '100px', 'marginBottom': '20px' }} color="primary" onClick={() => window.location.href = '/admin/allfuelpass'}>
