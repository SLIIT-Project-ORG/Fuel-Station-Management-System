                    ...
                    <div className="col-md-10 col-sm-11 display-table-cell v-align">
                        ...
                        <div className='container-table100'>
                            ...
                            <header class="bg-dark py-5">
                                <div class="container px-4 px-lg-5 my-5">
                                    <div class="text-center text-white">
                                        <h1 class="display-4 fw-bolder">Admin: Manage Fuel Inventory</h1>
                                        <p class="lead fw-normal text-white-50 mb-0">Fuel Inventory</p>
                                    </div>
                                </div>
                            </header>
                            <br></br>
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <a href="http://localhost:3000/addinventory" class="btn btn-primary btn-lg active" role="button" aria-pressed="true"> + Add New Fuel Inventory</a>
...
export default FuelInventoryManagement;